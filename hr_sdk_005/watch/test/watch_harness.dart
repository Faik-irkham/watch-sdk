...
const _eventChannels = {
  'samsung_health/heart_rate',
  'samsung_health/spo2',
  'samsung_health/accelerometer',
  'samsung_health/ppg',
};
...
Future<void> showScenario(WidgetTester tester, Widget app, Scenario scenario) async {
  ...
  // Mode berkala mendengarkan beberapa sensor; sensor selain yang diuji
  // tersambung tetapi diam.
  for (final name in _eventChannels) {
    if (name == scenario.page.channel) continue;
